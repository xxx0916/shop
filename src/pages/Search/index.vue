    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<i v-show="isOne" :class="{'el-icon-sort-down':isDesc,'el-icon-sort-up':isAsc}"></i></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a >价格<i v-show="isTwo" :class="{'el-icon-sort-down':isDesc,'el-icon-sort-up':isAsc}"></i></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <!-- 分页器 -->
          <Pageination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @getPageNo="getPageNo"></Pageination>
          <!-- <div class="fr page">
...
export default {
  ...
  watch: {
    ...
    $route(newValue, oldValue) {
      ...
      // 再次发送请求
      this.getData();
      // 每一次请求，都一个吧相应的1,2,3级分类的id置空，让他接收下一次的
      this.searchParams.category1Id = undefined;
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
    }
